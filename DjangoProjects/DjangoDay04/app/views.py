...
def basedemo(request):
	...
	context = { #字典的写法 key:value
		'name':'HelloWorld',
		'age':18,
		'score':[70,44,89],
		'username': 'root',    #root超级管理
		'scoredir':[
			{'语文':90},
			{'数学':90},
			{'英语':100}
...
def verifycode(request):
	...
	# 随机数生成
	remp = '12313781749153953096hkhekqnczbmnckjsahdkyfiuyi4bmnbmzczadaouwe'
	random_str = ''
	for i in range(0,4):
		random_str += remp[random.randrange(0,len(remp))]

	# 字体类型
	fontPath = os.path.join('app/MSYH.TTF')
